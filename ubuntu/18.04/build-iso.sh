...
TARGET_ISO=${2:-"`pwd`/docker-server-18.04.iso"}
...
cp "$SCRIPT_DIR/custom/locale" "./custom/locale"
cp "$SCRIPT_DIR/custom/keyboard" "./custom/keyboard"
cp "$SCRIPT_DIR/custom/prepare.sh" "./custom/prepare.sh"
